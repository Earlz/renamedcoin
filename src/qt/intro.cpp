...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/renamedcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Renamedcoin"),
     ...
     * override -datadir in the renamedcoin.conf file in the default data directory
     * (to be consistent with renamedcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
