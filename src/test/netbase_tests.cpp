...
{
    BOOST_CHECK(TestSplitHost("www.renamedcoin.org", "www.renamedcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.renamedcoin.org]", "www.renamedcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.renamedcoin.org:80", "www.renamedcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.renamedcoin.org]:80", "www.renamedcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5433", "127.0.0.1", 5433));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5433", "127.0.0.1", 5433));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5433", "::ffff:127.0.0.1", 5433));
    BOOST_CHECK(TestSplitHost("[::]:5433", "::", 5433));
    BOOST_CHECK(TestSplitHost("::5433", "::5433", -1));
    BOOST_CHECK(TestSplitHost(":5433", "", 5433));
    BOOST_CHECK(TestSplitHost("[]:5433", "", 5433));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5433", "127.0.0.1:5433"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5433", "[::]:5433"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
