...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("renamedcoin.sipa.be", "seed.renamedcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.renamedcoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("renamedcoinstats.com", "seed.renamedcoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("renamedcoin.petertodd.org", "testnet-seed.renamedcoin.petertodd.org"));
