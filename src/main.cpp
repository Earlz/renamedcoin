...
#if defined(NDEBUG)
# error "Renamedcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Renamedcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("renamedcoin-scriptch");
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; //always enabled for renamedcoin
    if (fEnforceBIP30) {
    ...
    bool fStrictPayToScriptHash = true; //always enabled for renamedcoin
...
bool AcceptBlock(CBlock& block, CValidationState& state, CDiskBlockPos* dbp)
{
    ...
    if (hash != Params().HashGenesisBlock()) {
        ...
        if (block.nVersion < 2 && block.nHeight!=0)
        {
