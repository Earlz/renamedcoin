Renamedcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/renamedcoin/files/Renamedcoin/renamedcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Renamedcoin
...
New/changed settings (command-line or renamedcoin.conf file)
--------------------------------------------------------
