The following is a list of assets used in the renamedcoin source and their proper attribution.
...
* License: MIT
* Site: [https://renamedcointalk.org/index.php?topic=15276.0](https://renamedcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original renamedcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/renamedcoin.icns, src/qt/res/src/renamedcoin.svg,
	src/qt/res/src/renamedcoin.ico, src/qt/res/src/renamedcoin.png,
	src/qt/res/src/renamedcoin_testnet.png, docs/renamedcoin_logo_doxygen.png,
