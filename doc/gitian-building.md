...
*Setup instructions for a gitian build of Renamedcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Renamedcoin
...
- [Building Renamedcoin](#building-renamedcoin)
...
Clone the git repositories for renamedcoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/renamedcoin/renamedcoin
```
...
In [doc/release-process.md](release-process.md) in the renamedcoin repository under 'Fetch and build inputs'.
...
Building Renamedcoin
----------------

To build Renamedcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the renamedcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/renamedcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/renamedcoin/renamedcoin
...
For example:
```bash
URL=https://github.com/laanwj/renamedcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit renamedcoin=${COMMIT} --url renamedcoin=${URL} ../renamedcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit renamedcoin=${COMMIT} --url renamedcoin=${URL} ../renamedcoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/renamedcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/renamedcoin-build.assert
```
...
[renamedcoin/gitian.sigs](https://github.com/renamedcoin/gitian.sigs/) repository, or
