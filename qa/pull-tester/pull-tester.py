#!/usr/bin/python
# Copyright (c) 2013 The Renamedcoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old RenamedcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/RenamedcoindComparisonTool_jar/RenamedcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/renamedcoin/renamedcoin.git")
...
environ_default("BUILD_PATH", "/mnt/renamedcoin")
...
environ_default("GITHUB_REPO", "renamedcoin/renamedcoin")
